...
DEFAULT_gamma_yield_fraction = 0.05 #fraction of yield deposited in prompt Gamma radiation
DEFAULT_Compton_KE = 1.28 #kinetic energy of Compton electron in MeV
DEFAULT_HOB = 100.0 #heigh of burst in km
DEFAULT_B = B0 #geomagnetic field strength in Teslas
DEFAULT_theta = np.pi/2 #angle between line of sight vector and magnetic field
DEFAULT_A = 0 #angle between radial ray from burst point to target and normal in radians
